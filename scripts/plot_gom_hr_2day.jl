...
snapshot_file = joinpath(@__DIR__, "..", "runs", "gom_hr_output",
                         "gom_hr_2days_snapshot_hycom.jld2")
...
eta_png = joinpath(fig_dir, "gom_hr_2day_eta.png")
...
plt_Ts = heatmap(
    ...
    xlabel         = "Longitude [°W]",
    ylabel         = "Latitude [°N]",
    title          = "GoM surface temperature after 2 days (HYCOM init)",
    colorbar_title = "T [°C]",
    clims          = (T_min, T_max),
    color          = cgrad(:thermal),
    nan_color      = :white,
...
Ts_png = joinpath(fig_dir, "gom_hr_2day_Tsurf.png")
...
bathy_png = joinpath(fig_dir, "gom_hr_2day_bathymetry.png")
